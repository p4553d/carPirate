...
$db_service = $SQL->getAll("SELECT
id,
CONCAT('<a class=\"menu\" href=\"servicedetail.php?sid=',id,'\">',name,'</a>')
...
<div id="content">
<div id="subhead">Services</div>
<? print maketable("Services", array("id", "name"), $db_service); ?>
<br/>
<form action="do_service.php" method="post">
<table cellspacing="0" class="contenttable">
	<tr class="tabtitle">
		<td colspan="4">Neue Service</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>Name:</td>
