...
opt.id,
CONCAT('<a class=\"menu\" href=\"masteroptionvalue.php?optionid=',opt.id,'\">', opt.name, '</a>'),
count(*) as cnt,
opt.through
FROM master_option opt LEFT JOIN master_optionvalue val
ON val.optionid = opt.id
GROUP BY opt.name
ORDER BY opt.name");
?>
...
<script type="text/javascript" src="../js/masteroption.js"></script>
<title>Master Optionen</title>
</head>
<body>
<div id="page">
...
<div id="content">
<div id="subhead">Master Optionen</div>
<? print(maketable("Optionen", array("id", "name", "Anzahl der Werte", "Schleuse"), $db_option)); ?>
<br />
<form action="do_masteroption.php" method="post">
<table cellspacing="0" class="contenttable">
	<tr class="tabtitle">
		<td colspan="4">Neue Option</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>Name:</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td>Schleuse:</td>
		<td><input type="checkbox" name="through" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
